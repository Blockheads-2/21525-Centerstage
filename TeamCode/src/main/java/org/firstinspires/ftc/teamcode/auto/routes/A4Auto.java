    ...
    public void runOpMode() throws InterruptedException {
        ...
        switch (elementLocation) {
            ...
            case LEFT:
                ...
                //Move to park
                constantHeading(0.3, 4, -34, 0, 0, 0); //y-value will changed based on the length of the claw; prob will have to tune x-value
            ...
            case RIGHT:
                ...
                //Move to park
                constantHeading(0.3, -5, -40, 0, 0, 0); //y-value will changed based on the length of the claw; prob will have to tune x-value
            ...
            case MID:
                ...
                constantHeading(0.3, 0, -37, 0, 0, 0); //y-value will changed based on the length of the claw; prob will have to tune x-value
