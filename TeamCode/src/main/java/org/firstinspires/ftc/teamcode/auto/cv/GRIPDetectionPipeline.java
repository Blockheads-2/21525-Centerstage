 ...
 * @author GRIP
 */
public class GRIPDetectionPipeline extends OpenCvPipeline {
    ...
    public GRIPDetectionPipeline(Telemetry t){
        telemetry = t;
    }
    ...
    public Mat processFrame(Mat source0) {
        ...
        double[] hslThresholdHue = {120, 180.0};
        double[] hslThresholdSaturation = {30, 255.0};
        double[] hslThresholdLuminance = {0.0, 180};
...
//            blobDet.read(tempFile.getPath());
        ...
        detector.detect(input, blobList, mask);
